module.exports = {
  ...
  "server.index-controls.added-file-to-index":                            "Added {{file}}",
  "server.index-controls.deleted-file":                                   "Removed {{file}}",
  "server.index-controls.state.importing":                                "Processing metadata...",
  "server.index-controls.importing-file":                                 "Working on {{file}}",
